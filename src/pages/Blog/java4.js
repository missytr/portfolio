...
function Java4() {
  ...
  const blogData = {
    ...
    subtitle: "Khám phá các chủ đề nâng cao: Multithreading, Exception Handling, Generics và Stream API",
    category: "Java Programming",
    author: "Trần Khánh Linh",
    publishDate: "2024-10-18",
    tags: ["Java", "Advanced", "Multithreading", "Exceptions", "Generics", "Stream API"],
    difficulty: "Advanced"
  };
    ...
    <div className={`blog-post-page ${isLoaded ? 'loaded' : ''}`}>
      ...
      <div className="blog-hero">
        ...
        <div className="blog-hero-image">
          <div className="image-placeholder">☕ Advanced</div>
