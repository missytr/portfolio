...
function Js2() {
  ...
  const blogData = {
    title: "JavaScript Advanced - Chủ Đề Nâng Cao",
    subtitle: "Tìm hiểu về Promises, Async/Await, Closures và các pattern programming nâng cao",
    category: "JavaScript Programming",
    author: "Trần Khánh Linh",
    publishDate: "2024-10-20",
    tags: ["JavaScript", "Advanced", "Promises", "Async", "Closures", "Patterns"],
    difficulty: "Advanced"
  };
      ...
      <div className="blog-hero">
        <div className="blog-hero-content">
          <div className="blog-breadcrumb">
            ...
            <Link to="/blog?category=javascript" className="breadcrumb-link">JavaScript</Link>
            <span className="breadcrumb-separator">•</span>
            <span className="breadcrumb-current">JavaScript Basics</span>
          </div>
