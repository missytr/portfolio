...
function Js1() {
  ...
  const blogData = {
    title: "JavaScript Basics - Nền Tảng Web Development",
    subtitle: "Tìm hiểu về JavaScript: Variables, Functions, DOM manipulation và ES6+ features",
    category: "JavaScript Programming",
    author: "Trần Khánh Linh",
    publishDate: "2024-10-19",
    tags: ["JavaScript", "ES6", "DOM", "Functions", "Variables", "Web Dev"],
    difficulty: "Beginner"
  };
